...
import static de.fraunhofer.fit.omp.reportgenerator.reporter.Config.PRIMARY_LANGUAGE;
...
public class Constants {
    ...
    public static List<String> getDocs(final Documentations documentations) {
        return documentations.getContent(PRIMARY_LANGUAGE, "");
    }

    public static List<String> getDocs(final Documentations documentations,
                                       final Documentations fallbackDocumentations) {
        return documentations.getContent(PRIMARY_LANGUAGE, "", () -> getDocs(fallbackDocumentations));
    }
}
