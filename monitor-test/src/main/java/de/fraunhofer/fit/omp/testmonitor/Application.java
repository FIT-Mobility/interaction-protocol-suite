...
import de.fraunhofer.fit.omp.testmonitor.configuration.Configuration;
...
import de.fraunhofer.fit.omp.testmonitor.configuration.visitor.BaseVisitor;
import de.fraunhofer.fit.omp.testmonitor.data.ValidatorFactory;
import de.fraunhofer.fit.omp.testmonitor.fuh.MqttBootstrapper;
import de.fraunhofer.fit.omp.testmonitor.reporting.MqttReporter;
import de.fraunhofer.fit.omp.testmonitor.reporting.ReporterBase;
import de.fraunhofer.fit.omp.testmonitor.reporting.VaasReporter;
import de.fraunhofer.fit.omp.testmonitor.routing.HttpCamel;
import de.fraunhofer.fit.omp.testmonitor.routing.MqttCamel;
import de.fraunhofer.fit.omp.testmonitor.routing.SoapCamel;
import de.fraunhofer.fit.omp.testmonitor.routing.VaasCamel;
import de.fraunhofer.fit.omp.testmonitor.routing.messagebased.MessageBasedExchangeHandlerFactory;
import de.fraunhofer.fit.omp.testmonitor.routing.soap.SoapExchangeHandlerFactory;
