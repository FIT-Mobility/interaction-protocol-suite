...
public class SimpleTypesTableHelper extends TableHelper {
    ...
    public void addRestriction(final Type.Simple.Restriction restriction) {
        ...
        insertDocumentation(createCellHelper(row, 2, Format.NORMAL), Constants.getDocs(context, restriction.getDocs()));
    }
    ...
    public void addList(final Type.Simple.List list) {
        ...
        insertDocumentation(createCellHelper(row, 2, Format.NORMAL), Constants.getDocs(context, list.getDocs()));
    }
    ...
    public void addUnion(final Type.Simple.Union union) {
        ...
        insertDocumentation(createCellHelper(row, 2, Format.NORMAL), Constants.getDocs(context, union.getDocs()));
    }
}
