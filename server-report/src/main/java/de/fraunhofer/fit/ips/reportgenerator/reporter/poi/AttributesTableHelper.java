...
public class AttributesTableHelper extends TableHelper {
    ...
    public void addAttributeDeclaration(final Context context,
                                        final Attributes.GlobalAttributeDeclaration attributeDeclaration) {
        ...
        insertDocumentation(createCellHelper(row, 2, Format.NORMAL), prependDefaultOrFixed(attributeDeclaration.getDefaultOrFixedValue(), Constants.getDocs(context, attributeDeclaration.getDocs())));
    }
}
