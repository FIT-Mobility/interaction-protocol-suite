package de.fraunhofer.fit.ips.reportgenerator.converter2;
...
public class NestedListFixer {
    ...
    public static String fixLists(final String richText) {
    ...
    private static String fixQuillIndentation(final String string)
    ...
    private static Document documentFromString(final String string) throws SAXException, IOException {
